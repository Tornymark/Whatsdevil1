...
module.exports = {
    ...
    SESSION: process.env.ALEXA_SESSION === undefined ? '' : process.env.AMAZONE_SESSION,
    LANG: process.env.LANGUAGE === undefined ? 'EN' : process.env.LANGUAGE.toUpperCase(),
    AUTOBIO: process.env.AUTO_BIO === undefined ? 'false' : process.env.AUTO_BIO,
    OWNER: process.env.OWNER_NAME === undefined ? 'EN CUZIER' : process.env.OWNER_NAME,
    OWNERNUM: process.env.OWNER_NUMBER === undefined ? '94770828171' : process.env.OWNER_NUMBER,
    ...
    DEVELOPER: 'En-Cuzier',
    AUTHOR: 'En-Cuzier',
    GIT: 'https://github.com/En-Cuzier/QUEEN-ALEXA',
    HEROKU: {
